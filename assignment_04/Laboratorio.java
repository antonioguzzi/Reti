...
public class Laboratorio {
    ...
    public Laboratorio(int ncomputers){
        ...
        for(int i = 0; i < ncomputers; i++) computers.add(Boolean.TRUE);
    }
    ...
    public void releaseAll(){
        for(int i = 0; i < ncomputers; i++) computers.set(i, Boolean.TRUE);
    }
    ...
    public void occupyAll(){
        for(int i = 0; i < ncomputers; i++) computers.set(i, Boolean.FALSE);
    }
